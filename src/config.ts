...
export const bossSpawningInterval = 1 * 60 * tps;

/** Amount of TICKs before the scoreboard update */
export const scoreboardUpdateInterval = 0.5 * tps;

/** Hashed (sha256) dev password */
export const devPasswordHash: string | undefined = process.env.DEV_PASSWORD_HASH || "xd";
...
export const maxPlayerLevel = 1000;
